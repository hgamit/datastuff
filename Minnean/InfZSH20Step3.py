...
n_steps_out = 1
pred_seq = y_whole[-1,1:3]#.reshape(-1, 1)
...
##plt.plot(hist.history['val_mean_squared_error'], coalor = 'red',  label = 'val_mean_squared_error')
...
pred_seq_reshape = pred_seq.reshape(1, 4, 1)
...
pred_reg= reg.predict(pred_seq.reshape(1, 4))
