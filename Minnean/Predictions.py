...
dataset_train = pd.read_csv('C:/Users/hmnsh/repos/datastuff/Minnean/marketdata/zsh20_daily_price-history-12-13-2019.csv', nrows=20) #, nrows=10
...
#	print("X_seq:",X_whole[i],"\ny_seq:", y_whole[i])

#print("Pred_row", last_row)
